...
public sealed partial class Wav : IAudioSource, IDisposable
{
    ...
    // ~Wav() unconditionally calls AudioSource::stop() which derefs mSoloud.
    ...
    public unsafe SoloudResult LoadMem(ReadOnlySpan<byte> data)
    {
        fixed (byte* p = data)
        {
            return (SoloudResult)Wav_loadMemEx(
                Handle,
                p,
                (uint)data.Length,
                aCopy: true,
    ...
    public unsafe SoloudResult LoadRawWave8(
    ...
    )
    {
        ...
        {
            return (SoloudResult)Wav_loadRawWave8Ex(
                Handle,
                p,
                (uint)samples.Length,
                sampleRate,
    ...
    public unsafe SoloudResult LoadRawWave16(
    ...
    )
    {
        ...
        {
            return (SoloudResult)Wav_loadRawWave16Ex(
                Handle,
                p,
                (uint)samples.Length,
                sampleRate,
    ...
    public unsafe SoloudResult LoadRawWave(
    ...
    )
    {
        ...
        {
            return (SoloudResult)Wav_loadRawWaveEx(
                Handle,
                p,
                (uint)samples.Length,
                sampleRate,
    ...
    private static partial nint Wav_create();

    [LibraryImport(LibraryName)]
    private static partial void Wav_destroy(nint wav);

    [LibraryImport(LibraryName, StringMarshalling = StringMarshalling.Utf8)]
    private static partial int Wav_load(nint wav, string filename);

    [LibraryImport(LibraryName)]
    private static unsafe partial int Wav_loadMemEx(
        nint wav,
        byte* mem,
        uint length,
    ...
    [LibraryImport(LibraryName)]
    private static unsafe partial int Wav_loadRawWave8Ex(
        nint wav,
        byte* mem,
        uint length,
        float samplerate,
    ...
    [LibraryImport(LibraryName)]
    private static unsafe partial int Wav_loadRawWave16Ex(
        nint wav,
        short* mem,
        uint length,
        float samplerate,
    ...
    [LibraryImport(LibraryName)]
    private static unsafe partial int Wav_loadRawWaveEx(
        nint wav,
        float* mem,
        uint length,
        float samplerate,
    ...
    [LibraryImport(LibraryName)]
    private static partial double Wav_getLength(nint wav);

    [LibraryImport(LibraryName)]
    private static partial void Wav_setVolume(nint wav, float volume);

    [LibraryImport(LibraryName)]
    private static partial void Wav_setLooping(nint wav, [MarshalAs(UnmanagedType.I4)] bool loop);

    [LibraryImport(LibraryName)]
    private static partial void Wav_setAutoStop(
        nint wav,
        [MarshalAs(UnmanagedType.I4)] bool autoStop
    );

    [LibraryImport(LibraryName)]
    private static partial void Wav_set3dMinMaxDistance(nint wav, float minDist, float maxDist);

    [LibraryImport(LibraryName)]
    private static partial void Wav_set3dAttenuation(nint wav, uint model, float rolloffFactor);

    [LibraryImport(LibraryName)]
    private static partial void Wav_set3dDopplerFactor(nint wav, float dopplerFactor);

    [LibraryImport(LibraryName)]
    private static partial void Wav_set3dListenerRelative(
        nint wav,
        [MarshalAs(UnmanagedType.I4)] bool listenerRelative
    );

    [LibraryImport(LibraryName)]
    private static partial void Wav_set3dDistanceDelay(nint wav, int distanceDelay);

    [LibraryImport(LibraryName)]
    private static partial void Wav_setInaudibleBehavior(
        nint wav,
    ...
    [LibraryImport(LibraryName)]
    private static partial void Wav_setLoopPoint(nint wav, double loopPoint);

    [LibraryImport(LibraryName)]
    private static partial double Wav_getLoopPoint(nint wav);

    [LibraryImport(LibraryName)]
    private static partial void Wav_stop(nint wav);
}
